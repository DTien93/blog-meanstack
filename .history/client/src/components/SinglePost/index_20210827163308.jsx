    ...
    return (
        <div className="singlePost">
            ...
            {post.photo && (
                ...
                updateMode ? <input type="text" value={title} className="singlePost__title-input" /> : (
                    <h1 className="singlePost__title">
                    {post.title}
                    {post.username === user?.username
                        && (
            ...
            {updateMode ? (
                <textarea className="singlePost__description-input" value={desc} onChange={() => setDesc(e.target.value)}/>
            ) : (    
