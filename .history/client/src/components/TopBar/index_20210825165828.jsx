    ...
    return (
        <div className="top">
            ...
            <div className="top__right">
                {user ? (
                    <Link>
                        <img className="top__right-img" src="https:/pds/2021/08/09/jisoo-blackpink-di-dong-phim-nhung-co-thanh-vien-nay-lai-duoc-khen-ve-dien-xuat-nhieu-hon_24560.jpg" alt="" />
                    </Link>
                ) : (
